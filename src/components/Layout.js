        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed text-base">
                Leader en sécurité privée en Guinée, nous nous engageons à fournir des solutions de sécurité innovantes et fiables depuis plus de 10 ans. Notre expertise et notre engagement envers l'excellence nous distinguent dans le secteur.
              </p>
              <div className="flex space-x-4 pt-2">
                <a href="https://www.facebook.com/" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-300 hover:bg-red-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <Link to="/careers" className="text-gray-300 hover:text-red-500 transition-colors flex items-center group">
                    <svg className="w-4 h-4 mr-2 text-red-600 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                    Carrières
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start group">
                  ...
                  <span className="text-gray-300">Conakry, Guinée<br />Rue XYZ, Quartier ABC</span>
                </li>
                <li className="flex items-start group">
                  <svg className="w-6 h-6 text-red-600 mr-3 flex-shrink-0 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="text-gray-300">contact@latvic.com</span>
                </li>
                <li className="flex items-start group">
                  <svg className="w-6 h-6 text-red-600 mr-3 flex-shrink-0 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div className="flex-grow md:mr-12 mb-6 md:mb-0">
                <h3 className="text-lg font-semibold text-white mb-3">Abonnez-vous à notre newsletter</h3>
                <p className="text-gray-400 text-sm">Recevez nos dernières actualités et offres directement dans votre boîte mail.</p>
              </div>
              <div className="flex-shrink-0 flex w-full md:w-auto">
                <input type="email" placeholder="Votre email" className="bg-gray-800 text-white px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-red-600 flex-grow md:w-64" />
                <button className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-r-md transition-colors">S'abonner</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                <a href="https://www.facebook.com/" className="text-gray-400 hover:text-red-500 text-sm transition-colors">
                  Mentions légales
                </a>
                <a href="https://www.facebook.com/" className="text-gray-400 hover:text-red-500 text-sm transition-colors">
